    ...
    <div className="about-kifaru flex flex-col lg:flex-row justify-center items-center gap-6 lg:gap-8 p-4 md:p-8 w-full">
      <div className="text-content flex flex-col gap-4 md:gap-6 lg:gap-10 max-w-lg order-2 lg:order-1 w-full">
        ...
        <p className="text-sm md:text-base leading-relaxed">
          True luxury whispers through the details where every space is crafted
          with intention and every moment feels effortlessly extraordinary. Our
          properties bring together the soul of culture, the serenity of nature,
          and the elegance of bespoke comfort. Here, architecture becomes art,
