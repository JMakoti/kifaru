...
export default function KifaruPropertyDetails() {
  ...
  const images = [msambweni, msambweni1, msambweni2].filter(
    Boolean
  ) as string[];
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row justify-between mb-6">
        <div>
          ...
          <div className="mt-2 text-gray-600">South Coast, Msambweni, Kenya</div>
        </div>
      </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    pristine white sand beaches. Indulge in fresh seafood at our
                    beachside restaurant, explore vibrant coral reefs, or simply
                    relax under swaying palm trees. This is coastal luxury at
                    its finest.
                  </p>
                </div>
              </div>
