          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <FormField
                  label="Guest Type"
                  htmlFor={`pricing-guest-${index}`}
                >
                  <Select
                    value={option.guest_type}
                    onValueChange={(value) =>
                      updateOption(index, "guest_type", value as GuestType)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <FormField label="Stay Type" htmlFor={`pricing-stay-${index}`}>
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateOption(index, "stay_type", value as StayType)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                >
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateOption(index, "price_per_night", e.target.value)
                      }
                      className="pl-10"
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                >
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateOption(index, "weekly_price", e.target.value)
                      }
                      className="pl-10"
                    />
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-background/50 rounded-lg border border-border/40">
                  <Label
                    htmlFor={`pricing-breakfast-${index}`}
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateOption(index, "includes_breakfast", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-background/50 rounded-lg border border-border/40">
                  <Label
                    htmlFor={`pricing-fullboard-${index}`}
                    className="text-sm cursor-pointer"
                  >
                    Full Board
                  </Label>
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateOption(index, "includes_fullboard", checked)
                    }
                  />
                </div>
              </div>
