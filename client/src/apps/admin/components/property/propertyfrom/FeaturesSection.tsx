...
import { FEATURE_TYPES, type Feature } from "@/types/property";
          ...
          >
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField label="Feature Type" htmlFor={`feature-type-${index}`}>
                  <Select 
                ...
                <FormField label="Icon (optional)" htmlFor={`feature-icon-${index}`}>
