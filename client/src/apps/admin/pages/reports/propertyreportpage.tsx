            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Property performance and occupancy analysis
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center min-h-96 rounded-lg border border-border bg-card p-12">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-6">
                There are no properties to report on at the moment. Property
                data will appear here once properties are added to the system.
              </p>
              <button
                onClick={() => navigate(-1)}
